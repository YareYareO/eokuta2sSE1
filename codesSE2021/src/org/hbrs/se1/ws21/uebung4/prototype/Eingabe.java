...
public class Eingabe {
    ...
    public void startEingabe() throws ContainerException, Exception {
        ...
        System.out.println("für store/enter, bitte in diesem Format eingeben-> Integer: id; String: Nachname; String: Vorname; String: Abteilung(optional); String: Expertise + Integer: ExpertisenBewertung (bis zu drei mal)" );
        ...
        while ( true ) {
            ...
            // Auswahl der bisher implementierten Befehle:
                ...
                erstelle(strings);
                System.out.println("Objekt erfolgreich eingefügt");
            }

            else if (  strings[0].equals("store")  ) {
                erstelle(strings);
                con.store();
                System.out.println("Objekt erfolgreich lokal gespeichert");
            }
    ...
    private void erstelle(String[] strings){
            ...
            else{emp.setName("ungültige Eingabe");}

            if(!Utility.hasNumbers(strings[3])) {
                emp.setVorname(strings[3]);
            }
            else{emp.setVorname("ungültige Eingabe");}

            int i = 4;
            if (!isNumeric(strings[5])) {
